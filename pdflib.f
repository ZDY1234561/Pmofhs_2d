...
!
     ...
     &   + ( 13860.0D+00 - ( 462.0D+00 - ( 132.0D+00 - ( 99.0D+00 -  
     &   140.0D+00/ f2 ) / f2 ) / f2 ) / f2 ) / f1 / 166320.0D+00 
     &   + ( 13860.0D+00 - ( 462.0D+00 - ( 132.0D+00 - ( 99.0D+00 - 
     &   140.0D+00 / z2 ) / z2 ) / z2 ) / z2 ) / z / 166320.0D+00 
     &   + ( 13860.0D+00 - ( 462.0D+00 - ( 132.0D+00 - ( 99.0D+00 - 
     &   140.0D+00 / x2 ) / x2 ) / x2 ) / x2 ) / x1 / 166320.0D+00 
     &   + ( 13860.0D+00 - ( 462.0D+00 - ( 132.0D+00 - ( 99.0D+00 -  
     &   140.0D+00/ w2 ) / w2 ) / w2 ) / w2 ) / w / 166320.0D+00
...
!
     ...
     &    4.463158187419713286462081D+11 /)
       real ( kind = 8 ) r8_gamma_log
       real ( kind = 8 ) res
       real ( kind = 8 ), parameter :: sqrtpi = 
     +  0.9189385332046727417803297D+00
       real ( kind = 8 ) x
...
!
       ...
       if ( rval <= 0.0D+00 ) then
         ...
         temp2 = df * 0.5D+00
         temp1 = - temp2 * log ( 2.0D+00 ) - ( temp2 + 1.0D+00 ) * log (
     &  rval )- 0.5D+00 / rval - r8_gamma_log ( temp2 )
